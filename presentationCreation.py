# Script usado para distribuir os slides que cada um teria de apresentar numa cadeira de programação.
# Algo a aprofundar mais tarde, com inputs e preferências de cada um.
